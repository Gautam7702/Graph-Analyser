			...
			switch (mode) {
				case 1: {
					if (cnt1 == 0) {
						...
						// );
						swal("EDIT MODE","Click on the node you want to move and then move it.","info")
						// console.log(cnt1)
					}
					cnt1++;
					break;
				...
				case 2: {
					if (cnt2 == 0) {
						swal("BFS MODE","Click on the node from where you want to start BFS.","info")
					}
					cnt2++;
					break;
				}
				case 3: {
					if (cnt3 == 0) {
						swal("DFS MODE","Click on the node from where you want to start DFS.","info")
					}
					cnt3++;
					break;
				}
